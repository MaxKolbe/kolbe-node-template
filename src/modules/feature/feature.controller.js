...
//CONTROLLER
var exampleController = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, _b, _c;
    return __generator(this, function (_d) {
        ...
        _c = req.params;
        if (!req.files)
            throw new error_js_1.ValidationError("Please upload the relevant file");
        if (!req.file)
            throw new error_js_1.ValidationError("Please upload the relevant file");
        try {
