...
exports.FEATURE_EVENTS = void 0;
var logger_config_js_1 = require("../configs/logger.config.js");
// import { sendEmail } from "../utils/sendEmail.util.js";
var events_js_1 = require("../lib/events.js");
// DEFINE EVENT NAMES AS CONSTANTS
exports.FEATURE_EVENTS = {
    FEATURE_ACTION: "feature:action",
    /**
     * ..other event names
     */
};
events_js_1.appEvents.on(exports.FEATURE_EVENTS.FEATURE_ACTION, function (data) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        try {
            logger_config_js_1.default.info("success", { data: data });
        }
        catch (err) {
            logger_config_js_1.default.error("failure", { data: data });
        }
        return [2 /*return*/];
    });
}); });
